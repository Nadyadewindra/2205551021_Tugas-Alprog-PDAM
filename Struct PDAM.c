...
void cover(){
	...
	printf("\t\t\t\t|                         Kelas B                         |\n");
	printf("\t\t\t\t|---------------------------------------------------------|\n");
	printf("\t\t\t\t| Nama	: Ni Nadya Dewindra Wirata                        |\n");
	printf("\t\t\t\t| NIM	: 2205551021                                      |\n");
	printf("\t\t\t\t|---------------------------------------------------------|\n");
	printf("\t\t\t\t|=========================================================|\n");
	printf("\t\t\t\t|_________________________________________________________|\n");
...
void golongan1_a1(){
	FILE *fPointer = fopen("Struct PDAM.txt", "w");
	char buff[255];
    char text[255];
	...
	fprintf(fPointer, " ______________________________________________________ \n");
	fprintf(fPointer, "|======================================================|\n");
	fprintf(fPointer, "|=>>    Rincian Pembayaran Penggunaan Air Minum     <<=|\n");
	fprintf(fPointer, "|------------------------------------------------------|\n");
	fprintf(fPointer, "  Pemakaian Bulan Lalu : %d m3\n", pemakaian_bulan_lalu);
	fprintf(fPointer, "  Pemakaian Saat Ini   : %d m3\n", pemakaian_saat_ini);
	fprintf(fPointer, "  Total Pemakaian      : %d m3\n", meter_kubik_air);
	fprintf(fPointer, "  Biaya Meter Air adalah Rp. %5.3f\n", biaya_meter);
	fprintf(fPointer, "|======================================================|\n");
	fprintf(fPointer, "| Biaya Lainnya :                                      |\n");
	fprintf(fPointer, "  1. Administrasi  : Rp. 1.000\n");
	fprintf(fPointer, "  2. BPM_R         : Rp. 12.500\n");
	fprintf(fPointer, "  3. Denda         : \n");
	fprintf(fPointer, "      a. Penggunaan <10 : Rp. 0\n");
	fprintf(fPointer, "      b. Penggunaan <20 : Rp. 5.000\n");
	fprintf(fPointer, "      c. Penggunaan >20 : Rp. 12.000\n");
	fprintf(fPointer, "      d. Penggunaan >30 : Rp. 20.000\n");
	fprintf(fPointer, "|======================================================|\n");
	fprintf(fPointer, "  Total Tagihan adalah Rp. %5.3f\n", tagihan);
	fprintf(fPointer, "|======================================================|\n");
	fprintf(fPointer, "|------------------------------------------------------|\n");
	fprintf(fPointer, "|                 --- TERIMAKASIH ---                  |\n");
	fprintf(fPointer, "|______________________________________________________|\n");
	fclose(fPointer);
}
...
void golongan1_e1(){
	...
	fprintf(fPointer, "| Biaya Lainnya :                                      |\n");
	fprintf(fPointer, "  1. Administrasi  : Rp. 1.000\n");
	fprintf(fPointer, "  2. BPM_S         : Rp. 12.500\n");
	fprintf(fPointer, "  3. Denda         : \n");
	fprintf(fPointer, "      a. Penggunaan <10 : Rp. 0\n");
	fprintf(fPointer, "      b. Penggunaan <20 : Rp. 15.000\n");
	fprintf(fPointer, "      c. Penggunaan >20 : Rp. 15.000\n");
	fprintf(fPointer, "|======================================================|\n");
	fprintf(fPointer, "  Total Tagihan adalah Rp. %5.3f\n", tagihan);
	fprintf(fPointer, "|======================================================|\n");
	fprintf(fPointer, "|------------------------------------------------------|\n");
...
void golongan1_e2(){
	...
	fprintf(fPointer, "  3. Denda         : \n");
	fprintf(fPointer, "      a. Penggunaan <10 : Rp. 0\n");
	fprintf(fPointer, "      b. Penggunaan <20 : Rp. 35.000\n");
	fprintf(fPointer, "      c. Penggunaan >20 : Rp. 35.000\n");
	fprintf(fPointer, "|======================================================|\n");
	fprintf(fPointer, "  Total Tagihan adalah Rp. %5.3f\n", tagihan);
	fprintf(fPointer, "|======================================================|\n");
	fprintf(fPointer, "|------------------------------------------------------|\n");
...
void golongan1_e3(){
	...
	fprintf(fPointer, "  3. Denda         : \n");
	fprintf(fPointer, "      a. Penggunaan <10 : Rp. 0\n");
	fprintf(fPointer, "      b. Penggunaan <20 : Rp. 75.000\n");
	fprintf(fPointer, "      c. Penggunaan >20 : Rp. 75.000\n");
	fprintf(fPointer, "|======================================================|\n");
	fprintf(fPointer, "  Total Tagihan adalah Rp. %5.3f\n", tagihan);
	fprintf(fPointer, "|======================================================|\n");
	fprintf(fPointer, "|------------------------------------------------------|\n");
